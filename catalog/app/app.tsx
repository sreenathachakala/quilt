...
__webpack_public_path__ = window.__webpack_public_path__= new URLSearchParams(location.search).get('base')
...
const history = createPreserveQueryHistory(createHistory, ['base'])({ basename: window.__webpack_public_path__ });
